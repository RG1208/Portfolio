...
const HomePage: React.FC = () => {
  useEffect(() => {
    ...
    document.title = 'Portfolio | Amit Kumar - B.Tech Student';
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Developing and implementing machine learning models for data analysis and predictive capabilities.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Creating cross-platform mobile applications with seamless user experiences and native-like performance.
              </p>
            </div>
          </div>
        </div>
